...
const ViewAppointment = () => {
  ...
  if (!appointment) {
    return (
      <div className="w-full mx-auto bg-white rounded-2xl shadow-lg p-12 mt-16 text-center border border-red-200">
  ...
  return (
    <div className="w-full mx-auto bg-gradient-to-br from-blue-50 to-white rounded-2xl shadow-2xl p-12 border border-blue-200">
      <h2 className="text-3xl font-extrabold text-blue-800 mb-5 tracking-tight text-center">Appointment Details</h2>
